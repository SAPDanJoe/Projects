	...
	Select Case wsArgNum
		...
		Case Else 
			For i = 0 To  wsArgNum - 1
				...
				Next
				If flag = 1 Then 
					msgbox FileName&" has been pinned to the start menu.  Windows explorer will now be restarted."
				ElseIf flag = 0 Then 
					msgbox "Ooops! Something went wrong and I couldn't pin "&FileName&" to start menu :("
				End If 
			Next 
	End Select 	
End Sub 
